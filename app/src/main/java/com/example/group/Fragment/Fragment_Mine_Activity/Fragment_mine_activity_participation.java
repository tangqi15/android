...
public class Fragment_mine_activity_participation extends Fragment {
    //活动正在参与
    View view = null;
    RecyclerView mine_activity_partcipation_recycle;
    private List<ActivityBean> items;
    EventAdapter eventAdapter;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_mine_activity_participation, container, false);
        initView();
        initSend();
        return view;
    }
    ...
    private void initView() {
        mine_activity_partcipation_recycle = view.findViewById(R.id.mine_activity_partcipation_recycle);
        //滑动组件
        LinearLayoutManager linearLayoutManager=new LinearLayoutManager(getContext());
        linearLayoutManager.setOrientation(LinearLayoutManager.VERTICAL);
        mine_activity_partcipation_recycle.setLayoutManager(linearLayoutManager);
        eventAdapter = new EventAdapter(getActivity(),items,R.layout.fragment_event_items);
        mine_activity_partcipation_recycle.setAdapter(eventAdapter);
        mine_activity_partcipation_recycle.setItemAnimator(new DefaultItemAnimator());
    }

    private void initSend() {
        ActivityModel activityModel = new ActivityModel();
        String user_id = getUser_id();
        activityModel.getMineActivityJoin(user_id,mine_activity_list_listener);
    }
