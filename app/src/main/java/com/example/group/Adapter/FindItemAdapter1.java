...
public class FindItemAdapter1 extends RecyclerView.Adapter {
    Context context;
    List<String> itemitems;
    int proint_item_item_image;
    FindItemVIewHolder findItemVIewHolder;

    public FindItemAdapter1(Context context, List<String> itemitems, int proint_item_item_image) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View itemView = LayoutInflater.from(context).inflate(R.layout.find_item_imgae1, viewGroup, false);
