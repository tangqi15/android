...
public class FindItemAdapter2 extends RecyclerView.Adapter {
    Context context;
    List<String> itemitems;
    int proint_item_item_image;
    FindItemVIewHolder findItemVIewHolder;
//两张图的时候
    public FindItemAdapter2(Context context, List<String> itemitems, int proint_item_item_image) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View itemView = LayoutInflater.from(context).inflate(R.layout.find_item_imgae2, viewGroup, false);
